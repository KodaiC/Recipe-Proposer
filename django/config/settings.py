...
db_URL = "postgresql://" + env.get_value("DATABASE_USER", default="django_user") + ":" + \
         env.get_value("DATABASE_PASSWORD", default="password") + "@" + \
         "localhost:5433/" + env.get_value("DATABASE_DB", default="db")
